...
class MateriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post materia_url, params: { materium: { delete: @materium.delete, edit: @materium.edit, index: @materium.index, show: @materium.show } }
    end
  ...
  test "should update materium" do
    patch materium_url(@materium), params: { materium: { delete: @materium.delete, edit: @materium.edit, index: @materium.index, show: @materium.show } }
